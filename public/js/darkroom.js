    ...
    Darkroom.prototype = {
        ...
        _replaceCurrentImage: function(newImage) {
            ...
            if (null !== this.options.ratio) {
                ...
                currentRatio > canvasRatio ? canvasHeight = canvasWidth / canvasRatio : currentRatio < canvasRatio && (canvasWidth = canvasHeight * canvasRatio)
            }
            var scaleMin = 1
              , scaleMax = 1
              , scaleX = 1
...
function() {
    ...
    Darkroom.plugins.crop = Darkroom.Plugin.extend({
        ...
        onObjectMoving: function(event) {
            if (this.hasFocus()) {
                ...
                if (currentObject === this.cropZone) {
                    ...
                    x < 0 && currentObject.set("left", 0),
                    y < 0 && currentObject.set("top", 0),
        ...
        onObjectScaling: function(event) {
            if (this.hasFocus()) {
                ...
                if (currentObject === this.cropZone) {
                    ...
                    if (null !== this.options.ratio && (minX < 0 || maxX > canvas.getWidth() || minY < 0 || maxY > canvas.getHeight()) && (preventScaling = !0),
                    minX < 0 || maxX > canvas.getWidth() || preventScaling) {
                        var lastScaleX = this.lastScaleX || 1;
                        currentObject.setScaleX(lastScaleX)
                    }
                    if (minX < 0 && currentObject.setLeft(0),
                    minY < 0 || maxY > canvas.getHeight() || preventScaling) {
                        var lastScaleY = this.lastScaleY || 1;
                        currentObject.setScaleY(lastScaleY)
                    }
                    minY < 0 && currentObject.setTop(0),
        ...
        _renderCropZone: function(fromX, fromY, toX, toY) {
            ...
            rightX - leftX < minWidth && (isRight ? rightX = leftX + minWidth : leftX = rightX - minWidth),
            bottomY - topY < minHeight && (isDown ? bottomY = topY + minHeight : topY = bottomY - minHeight),
            leftX < 0 && (rightX += Math.abs(leftX),
            leftX = 0),
            rightX > canvas.getWidth() && (leftX -= rightX - canvas.getWidth(),
            rightX = canvas.getWidth()),
            topY < 0 && (bottomY += Math.abs(topY),
            topY = 0),
