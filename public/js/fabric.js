...
fabric.Collection = {
    ...
    remove: function() {
        ...
        for (var n = 0, r = arguments.length; n < r; n++)
            ...
            t !== -1 && (e.splice(t, 1),
            this._onObjectRemoved(arguments[n]));
        return this.renderOnAddRemove && this.renderAll(),
        this
    },
...
function(e) {
    ...
    fabric.util = {
        ...
        loadImage: function(e, t, n, r) {
            ...
            ,
            e.indexOf("data") !== 0 && typeof r != "undefined" && (i.crossOrigin = r),
            i.src = e
        },
        ...
        createCanvasElement: function(e) {
            ...
            !e.getContext && typeof G_vmlCanvasManager != "undefined" && G_vmlCanvasManager.initElement(e),
            e
        },
        ...
        multiplyTransformMatrices: function(e, t) {
            var n = [[e[0], e[2], e[4]], [e[1], e[3], e[5]], [0, 0, 1]]
              , r = [[t[0], t[2], t[4]], [t[1], t[3], t[5]], [0, 0, 1]]
              , i = [];
            for (var s = 0; s < 3; s++) {
                i[s] = [];
                for (var o = 0; o < 3; o++) {
...
function() {
    ...
    function u(e, t, i, s, o, u, a, f) {
        ...
        if (n[l])
            return n[l];
        var c = Math.sqrt, h = Math.min, p = Math.max, d = Math.abs, v = [], m = [[], []], g, y, b, w, E, S, x, T;
        y = 6 * e - 12 * i + 6 * o,
        g = -3 * e + 9 * i - 9 * o + 3 * a,
        b = 3 * i - 3 * e;
        for (var N = 0; N < 2; ++N) {
        ...
        var C, k, L = v.length, A = L, O;
        while (L--)
            w = v[L],
            O = 1 - w,
            C = O * O * O * e + 3 * O * O * w * i + 3 * O * w * w * o + w * w * w * a,
            m[0][L] = C,
            k = O * O * O * t + 3 * O * O * w * s + 3 * O * w * w * u + w * w * w * f,
            m[1][L] = k;
        m[0][A] = e,
        m[1][A] = t,
        m[0][A + 1] = a,
    ...
    fabric.util.getBoundsOfArc = function(e, t, n, r, s, o, a, f, l) {
        ...
        for (var m = 0, g = v.length; m < g; m++)
            p = u(c, h, v[m][0], v[m][1], v[m][2], v[m][3], v[m][4], v[m][5]),
            p[0].x += e,
            p[0].y += t,
            p[1].x += e,
            p[1].y += t,
...
function() {
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function(e) {
        ...
        r !== r ? r = 0 : r !== 0 && r !== Number.POSITIVE_INFINITY && r !== Number.NEGATIVE_INFINITY && (r = (r > 0 || -1) * Math.floor(Math.abs(r))));
        if (r >= n)
            return -1;
...
function() {
    ...
    function o() {
        ...
        u.superclass = n,
        u.subclasses = [],
        n && (i.prototype = n.prototype,
        u.prototype = new i,
        n.subclasses.push(u));
        for (var a = 0, f = o.length; a < f; a++)
            r(u, o[a], n);
        return u.prototype.initialize || (u.prototype.initialize = t),
    ...
    var e = Array.prototype.slice
      ...
      , r = function(e, t, r) {
        for (var i in t)
            ...
            n && (t.toString !== Object.prototype.toString && (e.prototype.toString = t.toString),
...
function() {
    ...
    p = function(e, t, n) {
        ...
        var u = s(o, n);
        l[o][t].push(u),
        e.attachEvent("on" + t, u.wrappedHandler)
    }
    ,
    p = function(e, t, n) {
        var r = i(e), s;
        if (l[r] && l[r][t])
            for (var o = 0, u = l[r][t].length; o < u; o++)
                s = l[r][t][o],
                s && s.handler === n && (e.detachEvent("on" + t, s.wrappedHandler),
                l[r][t][o] = null)
    }
    ) : (h = function(e, t, n) {
        var r = i(e);
...
function() {
    function e(e, t) {
        ...
        if (typeof t == "string")
            ...
            t.indexOf("opacity") > -1 ? s(e, t.match(/opacity:\s*(\d?\.?\d*)/)[1]) : e;
        for (var r in t)
            if (r === "opacity")
                s(e, t[r]);
            else {
    ...
    : r && (s = function(e, t) {
        ...
        i.test(n.filter) ? (t = t >= .9999 ? "" : "alpha(opacity=" + t * 100 + ")",
        n.filter = n.filter.replace(i, t)) : n.filter += " alpha(opacity=" + t * 100 + ")",
        e
    }
    ),
...
function() {
    ...
    function a(e, t) {
        ...
        while (e && e.parentNode && !n)
            e = e.parentNode,
            e.nodeType === 1 && fabric.util.getElementStyle(e, "position") === "fixed" && (n = e),
            e.nodeType === 1 && r !== t && fabric.util.getElementStyle(e, "position") === "absolute" ? (i = 0,
            s = 0) : e === fabric.document ? (i = u.scrollLeft || o.scrollLeft || 0,
            s = u.scrollTop || o.scrollTop || 0) : (i += e.scrollLeft || 0,
            s += e.scrollTop || 0);
        return {
            left: i,
            top: s
    ...
    function f(e) {
        ...
        typeof e.getBoundingClientRect != "undefined" && (r = e.getBoundingClientRect()),
    ...
    function() {
        function n(e) {
            return typeof e.onselectstart != "undefined" && (e.onselectstart = fabric.util.falseFunction),
            t ? e.style[t] = "none" : typeof e.unselectable == "string" && (e.unselectable = "on"),
            e
        }
        function r(e) {
            return typeof e.onselectstart != "undefined" && (e.onselectstart = null),
            t ? e.style[t] = "" : typeof e.unselectable == "string" && (e.unselectable = ""),
            e
        }
...
function() {
    ...
    function r(r, i) {
        ...
        u.open(s, r, !0),
        (s === "POST" || s === "PUT") && u.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"),
        u.send(a),
        u
    }
    var t = function() {
...
function() {
    function e(e, t, n, r) {
        ...
        r = n / 4) : r = n / (2 * Math.PI) * Math.asin(t / e),
        {
            a: e,
            c: t,
            p: n,
    ...
    function o(e, t, n, r) {
        return e /= r / 2,
        e < 1 ? n / 2 * e * e * e * e + t : -n / 2 * ((e -= 2) * e * e * e - 2) + t
    }
    function u(e, t, n, r) {
    ...
    function f(e, t, n, r) {
        return e /= r / 2,
        e < 1 ? n / 2 * e * e * e * e * e + t : n / 2 * ((e -= 2) * e * e * e * e + 2) + t
    }
    function l(e, t, n, r) {
        return -n * Math.cos(e / r * (Math.PI / 2)) + n + t
    }
    ...
    function v(e, t, n, r) {
        return e === 0 ? t : e === r ? t + n : (e /= r / 2,
        e < 1 ? n / 2 * Math.pow(2, 10 * (e - 1)) + t : n / 2 * (-Math.pow(2, -10 * --e) + 2) + t)
    }
    function m(e, t, n, r) {
    ...
    function y(e, t, n, r) {
        return e /= r / 2,
        e < 1 ? -n / 2 * (Math.sqrt(1 - e * e) - 1) + t : n / 2 * (Math.sqrt(1 - (e -= 2) * e) + 1) + t
    }
    function b(n, r, i, s) {
        var o = 1.70158
          , u = 0
    ...
    function T(e, t, n, r, i) {
        return i === undefined && (i = 1.70158),
        e /= r / 2,
        e < 1 ? n / 2 * e * e * (((i *= 1.525) + 1) * e - i) + t : n / 2 * ((e -= 2) * e * (((i *= 1.525) + 1) * e + i) + 2) + t
    }
    function N(e, t, n, r) {
...
function(e) {
    ...
    function c(e, n, r, i) {
        var s = Object.prototype.toString.call(n) === "[object Array]", a;
        return e !== "fill" && e !== "stroke" || n !== "none" ? e === "strokeDashArray" ? n = n.replace(/,/g, " ").split(/\s+/).map(function(e) {
            return parseFloat(e)
        }) : e === "transformMatrix" ? r && r.transformMatrix ? n = u(r.transformMatrix, t.parseTransformAttribute(n)) : n = t.parseTransformAttribute(n) : e === "visible" ? (n = n === "none" || n === "hidden" ? !1 : !0,
        r && r.visible === !1 && (n = !1)) : e === "originX" ? n = n === "start" ? "left" : n === "end" ? "right" : "center" : a = s ? n.map(o) : o(n, i) : n = "",
        !s && isNaN(a) ? n : a
    }
    function h(e) {
        for (var n in f) {
    ...
    function v(e, n) {
        ...
        for (var i in t.cssRules[n])
            if (m(e, i.split(" ")))
                for (var s in t.cssRules[n][i])
                    r[s] = t.cssRules[n][i][s];
        return r
    }
    function m(e, t) {
        var n, r = !0;
    ...
    function y(e, t) {
        ...
        s = new RegExp("^" + n,"i"),
        t = t.replace(s, ""),
        i && t.length && (s = new RegExp("#" + i + "(?![a-zA-Z\\-]+)","i"),
        t = t.replace(s, ""));
        if (r && t.length) {
            r = r.split(" ");
    ...
    function b(e) {
        ...
        while (t.length) {
            var n = t[0], r = n.getAttribute("xlink:href").substr(1), i = n.getAttribute("x") || 0, s = n.getAttribute("y") || 0, o = e.getElementById(r).cloneNode(!0), u = (o.getAttribute("transform") || "") + " translate(" + i + ", " + s + ")", a;
    ...
    function w(e, n, r) {
        var i = new RegExp("^\\s*(" + t.reNum + "+)\\s*,?" + "\\s*(" + t.reNum + "+)\\s*,?" + "\\s*(" + t.reNum + "+)\\s*,?" + "\\s*(" + t.reNum + "+)\\s*" + "$"), s = e.getAttribute("viewBox"), o = 1, u = 1, a = 0, f = 0, l, c, h, p;
        if (!s || !(s = s.match(i)))
            return;
        a = -parseFloat(s[1]),
        f = -parseFloat(s[2]),
    ...
    t.parseTransformAttribute = function() {
        ...
        return function(u) {
            ...
            while (f.length > 1)
                f.shift(),
                l = t.util.multiplyTransformMatrices(l, f[0]);
            return l
        }
    }(),
    t.parseSVGDocument = function() {
        ...
        return function(s, u, a) {
            ...
            var g = p.filter(function(t) {
                return n.test(t.tagName) && w(t, 0, 0),
            ...
            t.parseElements(g, function(e) {
                t.documentParsingTime = new Date - f,
                u && u(e, y)
            }, i(y), a)
        }
    }();
    ...
    n(t, {
        parseFontDeclaration: function(e, n) {
            ...
            var s = i[1]
              ...
              , l = i[6];
            s && (n.fontStyle = s),
            u && (n.fontWeight = isNaN(parseFloat(u)) ? u : parseFloat(u)),
            a && (n.fontSize = o(a)),
            l && (n.fontFamily = l),
            f && (n.lineHeight = f === "normal" ? 1 : f)
        },
        ...
        parseAttributes: function(e, r, i) {
            ...
            e.parentNode && /^symbol|[g|a]$/i.test(e.parentNode.nodeName) && (o = t.parseAttributes(e.parentNode, r, i)),
            u = o && o.fontSize || e.getAttribute("font-size") || t.Text.DEFAULT_SVG_FONT_SIZE;
            var a = r.reduce(function(t, n) {
                return s = e.getAttribute(n),
                s && (n = l(n),
                s = c(n, s, o, u),
                t[n] = s),
                t
            }, {});
            return a = n(a, n(v(e, i), t.parseStyleAttribute(e))),
        ...
        parseStyleAttribute: function(e) {
            ...
            return n ? (typeof n == "string" ? p(n, t) : d(n, t),
            t) : t
        },
        ...
        loadSVGFromURL: function(e, n, r) {
            function i(i) {
                var s = i.responseXML;
                s && !s.documentElement && t.window.ActiveXObject && i.responseText && (s = new ActiveXObject("Microsoft.XMLDOM"),
                s.async = "false",
                s.loadXML(i.responseText.replace(/<!DOCTYPE[\s\S]*?(\[[\s\S]*\])*?>/i, "")));
        ...
        loadSVGFromString: function(e, n, r) {
            ...
            if (typeof DOMParser != "undefined") {
                ...
                t.window.ActiveXObject && (i = new ActiveXObject("Microsoft.XMLDOM"),
                i.async = "false",
        ...
        createSVGFontFacesMarkup: function(e) {
            ...
            return t && (t = ['<style type="text/css">', "<![CDATA[", t, "]]>", "</style>"].join("")),
            t
        },
        createSVGRefElementsMarkup: function(e) {
            var t = [];
            return x(t, e, "backgroundColor"),
            x(t, e, "overlayColor"),
            t.join("")
        }
    })
...
function(e) {
    ...
    t.Intersection.intersectLineLine = function(e, r, i, s) {
        ...
        if (f !== 0) {
            var l = u / f
              , c = a / f;
            0 <= l && l <= 1 && 0 <= c && c <= 1 ? (o = new n("Intersection"),
            o.points.push(new t.Point(e.x + l * (r.x - e.x),e.y + l * (r.y - e.y)))) : o = new n
        } else
    ...
    t.Intersection.intersectPolygonRectangle = function(e, r, i) {
        var s = r.min(i)
          ...
          , p = new n;
        return p.appendPoints(f.points),
...
function(e) {
    ...
    t.Color.reRGBa = /^rgba?\(\s*(\d{1,3}(?:\.\d+)?\%?)\s*,\s*(\d{1,3}(?:\.\d+)?\%?)\s*,\s*(\d{1,3}(?:\.\d+)?\%?)\s*(?:\s*,\s*(\d+(?:\.\d+)?)\s*)?\)$/,
    t.Color.reHSLa = /^hsla?\(\s*(\d{1,3})\s*,\s*(\d{1,3}\%)\s*,\s*(\d{1,3}\%)\s*(?:\s*,\s*(\d+(?:\.\d+)?)\s*)?\)$/,
...
function() {
    function e(e) {
        ...
        return r || (r = e.getAttribute("stop-color") || "rgb(0,0,0)"),
    ...
    function r(e, t, n) {
        ...
        for (var u in t) {
            r = parseFloat(t[u], 10),
            typeof t[u] == "string" && /^\d+%$/.test(t[u]) ? s = .01 : s = 1;
            if (u === "x1" || u === "x2" || u === "r2")
    ...
    fabric.Gradient = fabric.util.createClass({
        ...
        initialize: function(e) {
            ...
            this.type === "radial" && (t.r1 = e.coords.r1 || 0,
            t.r2 = e.coords.r2 || 0),
            this.coords = t,
        ...
        toSVG: function(e) {
            var t = fabric.util.object.clone(this.coords), n, r;
            ...
            this.gradientTransform && (r += ' gradientTransform="matrix(' + this.gradientTransform.join(" ") + ')" '),
            this.type === "linear" ? n = ["<linearGradient ", r, ' x1="', t.x1, '" y1="', t.y1, '" x2="', t.x2, '" y2="', t.y2, '">\n'] : this.type === "radial" && (n = ["<radialGradient ", r, ' cx="', t.x2, '" cy="', t.y2, '" r="', t.r2, '" fx="', t.x1, '" fy="', t.y1, '">\n']);
            for (var s = 0; s < this.colorStops.length; s++)
                n.push("<stop ", 'offset="', this.colorStops[s].offset * 100 + "%", '" style="stop-color:', this.colorStops[s].color, this.colorStops[s].opacity != null ? ";stop-opacity: " + this.colorStops[s].opacity : ";", '"/>\n');
        ...
        toLive: function(e, t) {
            ...
            if (t.group && t.group.type === "path-group")
                for (var i in r)
                    if (i === "x1" || i === "x2")
                        r[i] += -this.offsetX + t.width / 2;
                    else if (i === "y1" || i === "y2")
                        r[i] += -this.offsetY + t.height / 2;
            ...
            for (var s = 0, o = this.colorStops.length; s < o; s++) {
                ...
                typeof a != "undefined" && (u = (new fabric.Color(u)).setAlpha(a).toRgba()),
    ...
    fabric.util.object.extend(fabric.Gradient, {
        fromElement: function(i, s) {
            var o = i.getElementsByTagName("stop"), u = i.nodeName === "linearGradient" ? "linear" : "radial", a = i.getAttribute("gradientUnits") || "objectBoundingBox", f = i.getAttribute("gradientTransform"), l = [], c = {}, h;
...
fabric.Pattern = fabric.util.createClass({
    ...
    toSVG: function(e) {
        ...
        if (this.repeat === "repeat-y" || this.repeat === "no-repeat")
            n = 1;
        return t.src ? o = t.src : t.toDataURL && (o = t.toDataURL()),
        '<pattern id="SVGID_' + this.id + '" x="' + i + '" y="' + s + '" width="' + n + '" height="' + r + '">\n' + '<image x="0" y="0"' + ' width="' + t.width + '" height="' + t.height + '" xlink:href="' + o + '"></image>\n' + "</pattern>\n"
    },
    toLive: function(e) {
        var t = typeof this.source == "function" ? this.source() : this.source;
        if (!t)
    ...
    t.Shadow = t.util.createClass({
        ...
        toSVG: function(e) {
            var t = "SourceAlpha"
              , n = 40
              , r = 40;
            return e && (e.fill === this.color || e.stroke === this.color) && (t = "SourceGraphic"),
            e.width && e.height && (n = Math.abs(this.offsetX / e.getWidth()) * 100 + 20,
            r = Math.abs(this.offsetY / e.getHeight()) * 100 + 20),
        ...
        toObject: function() {
            ...
            return this.color !== n.color && (e.color = this.color),
    ...
    fabric.StaticCanvas = fabric.util.createClass({
        ...
        __setBgOverlayImage: function(e, t, n, r) {
            return typeof t == "string" ? fabric.util.loadImage(t, function(t) {
                this[e] = new fabric.Image(t,r),
                n && n()
            }, this, r && r.crossOrigin) : (this[e] = t,
            n && n()),
            this
        },
        ...
        setDimensions: function(e, t) {
            ...
            return t.cssOnly || this.renderAll(),
            this.calcOffset(),
            this
        },
        ...
        _renderBackground: function(e) {
            this.backgroundColor && (e.fillStyle = this.backgroundColor.toLive ? this.backgroundColor.toLive(e) : this.backgroundColor,
            e.fillRect(this.backgroundColor.offsetX || 0, this.backgroundColor.offsetY || 0, this.width, this.height)),
            this.backgroundImage && this._draw(e, this.backgroundImage)
        },
        _renderOverlay: function(e) {
            this.overlayColor && (e.fillStyle = this.overlayColor.toLive ? this.overlayColor.toLive(e) : this.overlayColor,
            e.fillRect(this.overlayColor.offsetX || 0, this.overlayColor.offsetY || 0, this.width, this.height)),
        ...
        _toObjectMethod: function(t, n) {
            ...
            return e(i, this.__serializeBgOverlay()),
        ...
        __serializeBgOverlay: function() {
            ...
            return this.overlayColor && (e.overlay = this.overlayColor.toObject ? this.overlayColor.toObject() : this.overlayColor),
            this.backgroundImage && (e.backgroundImage = this.backgroundImage.toObject()),
        ...
        _setSVGHeader: function(e, t) {
            var n, r, i;
            t.viewBox ? (n = t.viewBox.width,
            r = t.viewBox.height) : (n = this.width,
            r = this.height,
            this.svgViewportTransformation || (i = this.viewportTransform,
            n /= i[0],
            r /= i[3])),
...
function() {
    fabric.PencilBrush = fabric.util.createClass(fabric.BaseBrush, {
        ...
        _render: function() {
            ...
            e.beginPath(),
            this._points.length === 2 && n.x === r.x && n.y === r.y && (n.x -= .5,
            r.x += .5),
            e.moveTo(n.x, n.y);
...
fabric.SprayBrush = fabric.util.createClass(fabric.BaseBrush, {
    ...
    addSprayChunk: function(e) {
        ...
        for (var s = 0; s < this.density; s++) {
            ...
            this.dotWidthVariance ? r = fabric.util.getRandomInt(Math.max(1, this.dotWidth - this.dotWidthVariance), this.dotWidth + this.dotWidthVariance) : r = this.dotWidth;
...
function() {
    ...
    fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
        ...
        _resetCurrentTransform: function(e) {
            ...
            this._shouldCenterTransform(e, t.target) ? t.action === "rotate" ? this._setOriginToCenter(t.target) : (t.originX !== "center" && (t.originX === "right" ? t.mouseXSign = -1 : t.mouseXSign = 1),
            t.originY !== "center" && (t.originY === "bottom" ? t.mouseYSign = -1 : t.mouseYSign = 1),
            t.originX = "center",
        ...
        _normalizePointer: function(e, t) {
            ...
            return s && (o = new fabric.Point(n.left,n.top),
        ...
        _shouldCenterTransform: function(e, t) {
            ...
            return n.action === "scale" || n.action === "scaleX" || n.action === "scaleY" ? r = this.centeredScaling || t.centeredScaling : n.action === "rotate" && (r = this.centeredRotation || t.centeredRotation),
            r ? !e.altKey : e.altKey
        },
        ...
        _getActionFromCorner: function(e, t) {
            var n = "drag";
            return t && (n = t === "ml" || t === "mr" ? "scaleX" : t === "mt" || t === "mb" ? "scaleY" : t === "mtr" ? "rotate" : "scale"),
            n
        },
        ...
        _setObjectScale: function(e, t, n, r, i, s) {
            ...
            i === "equally" && !n && !r ? u || a || this._scaleObjectEqually(e, o, t) : i ? i === "x" && !o.get("lockUniScaling") ? u || n || o.set("scaleX", t.newScaleX) : i === "y" && !o.get("lockUniScaling") && (a || r || o.set("scaleY", t.newScaleY)) : (u || n || o.set("scaleX", t.newScaleX),
        ...
        _flipObject: function(e, t) {
            e.newScaleX < 0 && t !== "y" && (e.originX === "left" ? e.originX = "right" : e.originX === "right" && (e.originX = "left")),
            e.newScaleY < 0 && t !== "x" && (e.originY === "top" ? e.originY = "bottom" : e.originY === "bottom" && (e.originY = "top"))
        },
        _setLocalMouse: function(e, t) {
            var n = t.target;
            t.originX === "right" ? e.x *= -1 : t.originX === "center" && (e.x *= t.mouseXSign * 2,
            e.x < 0 && (t.mouseXSign = -t.mouseXSign)),
            t.originY === "bottom" ? e.y *= -1 : t.originY === "center" && (e.y *= t.mouseYSign * 2,
        ...
        _drawSelection: function() {
            ...
            if (this.selectionDashArray.length > 1) {
                var a = t.ex + s - (n > 0 ? 0 : o)
                  , f = t.ey + s - (r > 0 ? 0 : u);
                e.beginPath(),
                fabric.util.drawDashedLine(e, a, f, a + o, f, this.selectionDashArray),
                fabric.util.drawDashedLine(e, a, f + u - 1, a + o, f + u - 1, this.selectionDashArray),
                fabric.util.drawDashedLine(e, a, f, a, f + u, this.selectionDashArray),
                fabric.util.drawDashedLine(e, a + o - 1, f, a + o - 1, f + u, this.selectionDashArray),
                e.closePath(),
                e.stroke()
            } else
        ...
        _fireOverOutEvents: function(e) {
            ...
            e.fire("mouseover"),
            this._hoveredTarget && (this.fire("mouse:out", {
        ...
        getPointer: function(t, n, r) {
            ...
            var i = e(t, r), s = r.getBoundingClientRect(), o = s.width || 0, u = s.height || 0, a;
            if (!o || !u)
            ...
            n || (i = fabric.util.transformPoint(i, fabric.util.invertTransform(this.viewportTransform))),
            o === 0 || u === 0 ? a = {
                width: 1,
                height: 1
            } : a = {
...
function() {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        _onMouseDown: function(e) {
            ...
            n(this.upperCanvasEl, "mousemove", this._onMouseMove),
            n(this.upperCanvasEl, "touchmove", this._onMouseMove),
            e.type === "touchstart" ? n(this.upperCanvasEl, "mousedown", this._onMouseDown) : (t(fabric.document, "mouseup", this._onMouseUp),
        ...
        __onMouseUp: function(e) {
            ...
            t = this._currentTransform.target) : t = this.findTarget(e, !0);
        ...
        _onMouseDownInDrawingMode: function(e) {
            ...
            this.freeDrawingBrush.onMouseDown(n),
        ...
        __onMouseDown: function(e) {
            ...
            this._shouldClearSelection(e, n) ? this._clearSelection(e, n, r) : s && (this._handleGrouping(e, n),
            n = this.getActiveGroup()),
            n && n.selectable && !s && (this._beforeTransform(e, n),
            this._setupCurrentTransform(e, n)),
            i && this.renderAll(),
            this.fire("mouse:down", {
                target: n,
                e: e
        ...
        _beforeTransform: function(e, t) {
            ...
            (n = t._findTargetCorner(this.getPointer(e))) && this.onBeforeScaleRotate(t),
        ...
        __onMouseMove: function(e) {
            ...
            !t || t && !t.selectable ? this.setCursor(this.defaultCursor) : this._setCursorFromEvent(e, t)),
            this.fire("mouse:move", {
                target: t,
                e: e
            }),
        ...
        _performTransformAction: function(e, t, n) {
            var r = n.x
              ...
              , s = t.target
              , o = t.action;
            o === "rotate" ? (this._rotateObject(r, i),
            this._fire("rotating", s, e)) : o === "scale" ? (this._onScale(e, t, r, i),
            this._fire("scaling", s, e)) : o === "scaleX" ? (this._scaleObject(r, i, "x"),
            this._fire("scaling", s, e)) : o === "scaleY" ? (this._scaleObject(r, i, "y"),
            this._fire("scaling", s, e)) : (this._translateObject(r, i),
        ...
        _onScale: function(e, t, n, r) {
            (e.shiftKey || this.uniScaleTransform) && !t.target.get("lockUniScaling") ? (t.currentAction = "scale",
            this._scaleObject(n, r)) : (!t.reset && t.currentAction === "scale" && this._resetCurrentTransform(e, t.target),
        ...
        _setCursorFromEvent: function(e, t) {
            ...
            return r ? this._setCornerCursor(r, t) : this.setCursor(t.hoverCursor || this.hoverCursor),
            !0
        },
...
function() {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        _handleGrouping: function(e, t) {
            ...
            this.getActiveGroup() ? this._updateActiveGroup(t, e) : this._createActiveGroup(t, e),
...
fabric.util.object.extend(fabric.StaticCanvas.prototype, {
    ...
    __getCroppedCanvas: function(e, t) {
        ...
        return i && (n = fabric.util.createCanvasElement(),
        r = n.getContext("2d"),
    ...
    __toDataURLWithMultiplier: function(e, t, n, r) {
        ...
        f ? this._tempRemoveBordersControlsFromGroup(f) : a && this.deactivateAll && this.deactivateAll(),
        this.renderAll(!0);
        ...
        f ? this._restoreBordersControlsOnGroup(f) : a && this.setActiveObject && this.setActiveObject(a),
        this.contextTop && this.clearContext(this.contextTop),
        this.renderAll(),
        c
    },
...
function(e) {
    ...
    t.Object = t.util.createClass({
        ...
        set: function(e, t) {
            return typeof e == "object" ? this._setObject(e) : typeof t == "function" && e !== "clipTo" ? this._set(e, t(this.get(e))) : this._set(e, t),
            this
        },
        _set: function(e, n) {
            var i = e === "scaleX" || e === "scaleY";
            return i && (n = this._constrainScale(n)),
            e === "scaleX" && n < 0 ? (this.flipX = !this.flipX,
            n *= -1) : e === "scaleY" && n < 0 ? (this.flipY = !this.flipY,
            n *= -1) : e === "width" || e === "height" ? this.minScaleLimit = r(Math.min(.1, 1 / Math.max(this.width, this.height)), 2) : e === "shadow" && n && !(n instanceof t.Shadow) && (n = new t.Shadow(n)),
            this[e] = n,
            this
        },
        toggle: function(e) {
            var t = this.get(e);
            return typeof t == "boolean" && this.set(e, !t),
            this
        },
        ...
        render: function(e, n) {
            ...
            this.group && this.group.type === "path-group" && e.translate(-this.group.width / 2, -this.group.height / 2),
        ...
        _renderControls: function(e, n) {
            ...
            if (this.active && !n) {
                var i;
                this.group && (i = t.util.transformPoint(this.group.getCenterPoint(), r),
                e.translate(i.x, i.y),
                e.rotate(s(this.group.angle))),
                i = t.util.transformPoint(this.getCenterPoint(), r, null != this.group),
                this.group && (i.x *= this.group.scaleX,
                i.y *= this.group.scaleY),
                e.translate(i.x, i.y),
                e.rotate(s(this.angle)),
                this.drawBorders(e),
                this.drawControls(e)
        ...
        _setShadow: function(e) {
            ...
            e.shadowColor = this.shadow.color,
            e.shadowBlur = this.shadow.blur * t * (this.scaleX + this.scaleY) / 2,
            e.shadowOffsetX = this.shadow.offsetX * t * this.scaleX,
            e.shadowOffsetY = this.shadow.offsetY * t * this.scaleY
        },
        ...
        _renderFill: function(e) {
            ...
            this.fill.toLive && e.translate(-this.width / 2 + this.fill.offsetX || 0, -this.height / 2 + this.fill.offsetY || 0),
        ...
        toDataURL: function(e) {
            ...
            this.set("active", !1),
            this.setPositionByOrigin(new t.Point(n.width / 2,n.height / 2), "center", "center");
            var o = this.canvas;
            i.add(this);
            var u = i.toDataURL(e);
        ...
        _setupCompositeOperation: function(e) {
            this.globalCompositeOperation && (this._prevGlobalCompositeOperation = e.globalCompositeOperation,
...
function() {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        translateToCenterPoint: function(t, n, r) {
            ...
            return n === "left" ? i = t.x + (this.getWidth() + o * this.scaleX) / 2 : n === "right" && (i = t.x - (this.getWidth() + o * this.scaleX) / 2),
            r === "top" ? s = t.y + (this.getHeight() + o * this.scaleY) / 2 : r === "bottom" && (s = t.y - (this.getHeight() + o * this.scaleY) / 2),
        ...
        toLocalPoint: function(t, n, r) {
            ...
            return n && r ? (n === "left" ? o = i.x - (this.getWidth() + s * this.scaleX) / 2 : n === "right" ? o = i.x + (this.getWidth() + s * this.scaleX) / 2 : o = i.x,
            r === "top" ? u = i.y - (this.getHeight() + s * this.scaleY) / 2 : r === "bottom" ? u = i.y + (this.getHeight() + s * this.scaleY) / 2 : u = i.y) : (o = this.left,
            u = this.top),
            fabric.util.rotatePoint(new fabric.Point(t.x,t.y), i, -e(this.angle)).subtractEquals(new fabric.Point(o,u))
        },
        ...
        adjustPosition: function(t) {
            var n = e(this.angle)
              ...
              , u = Math.cos(n) * o
              , a = Math.sin(n) * o;
            this.originX === "center" && t === "left" || this.originX === "right" && t === "center" ? (this.left -= i,
            this.top -= s) : this.originX === "left" && t === "center" || this.originX === "center" && t === "right" ? (this.left += i,
            this.top += s) : this.originX === "left" && t === "right" ? (this.left += u,
            this.top += a) : this.originX === "right" && t === "left" && (this.left -= u,
            this.top -= a),
            this.setCoords(),
            this.originX = t
        },
...
function() {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        setCoords: function() {
            ...
            return N = N.add(new fabric.Point(-P,-H)),
            C = C.add(new fabric.Point(H,-P)),
            k = k.add(new fabric.Point(P,H)),
            L = L.add(new fabric.Point(-H,P)),
            A = A.add(new fabric.Point((-P - H) / 2,(-H + P) / 2)),
            O = O.add(new fabric.Point((H - P) / 2,-(H + P) / 2)),
            M = M.add(new fabric.Point((H + P) / 2,(H - P) / 2)),
            _ = _.add(new fabric.Point((P - H) / 2,(P + H) / 2)),
            D = D.add(new fabric.Point((H - P) / 2,-(H + P) / 2)),
            this.oCoords = {
                tl: N,
                tr: C,
                br: k,
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        drawBorders: function(e) {
            ...
            var v = fabric.util.transformPoint(new fabric.Point(o,u), r, !0)
              , m = v.x
              , g = v.y;
            this.group && (m *= this.group.scaleX,
            g *= this.group.scaleY),
            e.strokeRect(~~(-(m / 2) - t) - .5, ~~(-(g / 2) - t) - .5, ~~(m + n) + 1, ~~(g + n) + 1);
            if (this.hasRotatingPoint && this.isControlVisible("mtr") && !this.get("lockRotation") && this.hasControls) {
                var y = (-g - t * 2) / 2;
                e.beginPath(),
                e.moveTo(0, y),
                e.lineTo(0, y - this.rotatingPointOffset),
                e.closePath(),
                e.stroke()
            }
            return e.restore(),
        ...
        drawControls: function(e) {
            ...
            this._drawControl("tl", e, E, m - b - y, g - b - y),
            this._drawControl("tr", e, E, m + d - b + y, g - b - y),
            this._drawControl("bl", e, E, m - b - y, g + v + w + y),
            this._drawControl("br", e, E, m + d + w + y, g + v + w + y),
            this.get("lockUniScaling") || (this._drawControl("mt", e, E, m + d / 2 - b, g - b - y),
            this._drawControl("mb", e, E, m + d / 2 - b, g + v + w + y),
            this._drawControl("mr", e, E, m + d + w + y, g + v / 2 - b),
            this._drawControl("ml", e, E, m - b - y, g + v / 2 - b)),
            this.hasRotatingPoint && this._drawControl("mtr", e, E, m + d / 2 - b, g - this.rotatingPointOffset - this.cornerSize / 2 - y),
            e.restore(),
            this
        },
        _drawControl: function(e, n, r, i, s) {
            var o = this.cornerSize;
            this.isControlVisible(e) && (t() || this.transparentCorners || n.clearRect(i, s, o, o),
            n[r](i, s, o, o))
        },
...
fabric.util.object.extend(fabric.Object.prototype, {
    ...
    _animate: function(e, t, n, r) {
        ...
        "from"in n || (n.from = o),
        ~t.indexOf("=") ? t = o + parseFloat(t.replace("=", "")) : t = parseFloat(t),
        fabric.util.animate({
            startValue: n.from,
            endValue: t,
            byValue: n.by,
...
function(e) {
    ...
    t.Line = t.util.createClass(t.Object, {
        ...
        _renderDashedStroke: function(e) {
            ...
            e.beginPath(),
            t.util.drawDashedLine(e, n.x1, n.y1, n.x2, n.y2, this.strokeDashArray),
            e.closePath()
        },
        toObject: function(e) {
...
function(e) {
    ...
    t.Circle = t.util.createClass(t.Object, {
        ...
        toSVG: function(e) {
            ...
            if (s === 0)
                this.group && this.group.type === "path-group" && (r = this.left + this.radius,
                i = this.top + this.radius),
                t.push("<circle ", 'cx="' + r + '" cy="' + i + '" ', 'r="', this.radius, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), " ", this.getSvgTransformMatrix(), '"/>\n');
            else {
        ...
        setRadius: function(e) {
            this.radius = e,
            this.set("width", e * 2).set("height", e * 2)
        },
        complexity: function() {
            return 1
        }
    ...
    t.Triangle = t.util.createClass(t.Object, {
        ...
        toSVG: function(e) {
            var t = this._createBaseSVGMarkup()
              ...
              , r = this.height / 2
              , i = [-n + " " + r, "0 " + -r, n + " " + r].join(",");
            return t.push("<polygon ", 'points="', i, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), '"/>'),
            e ? e(t.join("")) : t.join("")
        },
        complexity: function() {
            return 1
    ...
    t.Ellipse = t.util.createClass(t.Object, {
        ...
        toSVG: function(e) {
            var t = this._createBaseSVGMarkup()
              , n = 0
              , r = 0;
            return this.group && this.group.type === "path-group" && (n = this.left + this.rx,
            r = this.top + this.ry),
            t.push("<ellipse ", 'cx="', n, '" cy="', r, '" ', 'rx="', this.rx, '" ry="', this.ry, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), this.getSvgTransformMatrix(), '"/>\n'),
            e ? e(t.join("")) : t.join("")
        },
        _render: function(e, t) {
            e.beginPath(),
...
function(e) {
    ...
    t.Rect = t.util.createClass(t.Object, {
        ...
        _render: function(e, t) {
            ...
            e.moveTo(o + n, u),
            e.lineTo(o + i - n, u),
            a && e.bezierCurveTo(o + i - f * n, u, o + i, u + f * r, o + i, u + r),
            e.lineTo(o + i, u + s - r),
            a && e.bezierCurveTo(o + i, u + s - f * r, o + i - f * n, u + s, o + i - n, u + s),
            e.lineTo(o + n, u + s),
            a && e.bezierCurveTo(o + f * n, u + s, o, u + s - f * r, o, u + s - r),
            e.lineTo(o, u + r),
        ...
        _renderDashedStroke: function(e) {
            ...
            t.util.drawDashedLine(e, n + i, r, n + i, r + s, this.strokeDashArray),
            t.util.drawDashedLine(e, n + i, r + s, n, r + s, this.strokeDashArray),
    ...
    t.Rect.fromElement = function(e, r) {
        ...
        return i.left = i.left || 0,
        i.top = i.top || 0,
        new t.Rect(n(r ? t.util.object.clone(r) : {}, i))
    }
    ,
...
function(e) {
    ...
    t.Polyline = t.util.createClass(t.Object, {
        ...
        _render: function(e) {
            t.Polygon.prototype.commonRender.call(this, e),
            this._renderFill(e),
            this._renderStroke(e)
        },
        _renderDashedStroke: function(e) {
...
function(e) {
    ...
    t.Polygon = t.util.createClass(t.Object, {
        ...
        commonRender: function(e) {
            var t;
            e.beginPath(),
            this._applyPointOffset && ((!this.group || this.group.type !== "path-group") && this._applyPointOffset(),
...
function(e) {
    ...
    t.Path = t.util.createClass(t.Object, {
        ...
        initialize: function(e, t) {
            ...
            r.left += this.originX === "center" ? this.width / 2 : this.originX === "right" ? this.width : 0,
            r.top += this.originY === "center" ? this.height / 2 : this.originY === "bottom" ? this.height : 0,
        ...
        _render: function(e) {
            var t, n = null, r = 0, i = 0, s = 0, u = 0, a = 0, f = 0, l, c, h, p, d = -this.pathOffset.x, v = -this.pathOffset.y;
            this.group && this.group.type === "path-group" && (d = 0,
            v = 0),
            e.beginPath();
            for (var m = 0, g = this.path.length; m < g; ++m) {
                ...
                case "c":
                    ...
                    a = s + t[3],
                    f = u + t[4],
                    e.bezierCurveTo(s + t[1] + d, u + t[2] + v, a + d, f + v, l + d, c + v),
                    s = l,
                    u = c;
                    break;
                case "C":
                    ...
                    a = t[3],
                    f = t[4],
                    e.bezierCurveTo(t[1] + d, t[2] + v, a + d, f + v, s + d, u + v);
                    break;
                case "s":
                    l = s + t[3],
                    c = u + t[4],
                    a = a ? 2 * s - a : s,
                    f = f ? 2 * u - f : u,
                    e.bezierCurveTo(a + d, f + v, s + t[1] + d, u + t[2] + v, l + d, c + v),
                    a = s + t[1],
                    f = u + t[2],
                    s = l,
                    u = c;
                ...
                case "S":
                    ...
                    a = 2 * s - a,
                    f = 2 * u - f,
                    e.bezierCurveTo(a + d, f + v, t[1] + d, t[2] + v, l + d, c + v),
                    s = l,
                    u = c,
                    a = t[1],
                    f = t[2];
                ...
                case "q":
                    ...
                    a = s + t[1],
                    f = u + t[2],
                    e.quadraticCurveTo(a + d, f + v, l + d, c + v),
                    s = l,
                    u = c;
                    break;
                case "Q":
                    l = t[3],
                    c = t[4],
                    e.quadraticCurveTo(t[1] + d, t[2] + v, l + d, c + v),
                    s = l,
                    u = c,
                    a = t[1],
                    f = t[2];
                ...
                case "t":
                    l = s + t[1],
                    c = u + t[2],
                    n[0].match(/[QqTt]/) === null ? (a = s,
                    f = u) : n[0] === "t" ? (a = 2 * s - h,
                    f = 2 * u - p) : n[0] === "q" && (a = 2 * s - a,
                    f = 2 * u - f),
                    h = a,
                    p = f,
                    e.quadraticCurveTo(a + d, f + v, l + d, c + v),
                ...
                case "T":
                    ...
                    break;
                case "a":
                    o(e, s + d, u + v, [t[1], t[2], t[3], t[4], t[5], t[6] + s + d, t[7] + u + v]),
                    s += t[6],
                    u += t[7];
                    break;
                case "A":
                    o(e, s + d, u + v, [t[1], t[2], t[3], t[4], t[5], t[6] + d, t[7] + v]),
                    s = t[6],
                    u = t[7];
                    break;
                case "z":
        ...
        _parsePath: function() {
            var e = [], t = [], n, r, i = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/ig, s, o;
        ...
        _parseDimensions: function() {
            var e = [], i = [], s, o = null, u = 0, a = 0, f = 0, l = 0, c = 0, h = 0, p, d, v, m, g;
            for (var y = 0, b = this.path.length; y < b; ++y) {
                ...
                case "c":
                    ...
                    c = f + s[3],
                    h = l + s[4],
                    g = t.util.getBoundsOfCurve(f, l, f + s[1], l + s[2], c, h, p, d),
                    f = p,
                    l = d;
                    break;
                case "C":
                    ...
                    c = s[3],
                    h = s[4],
                    g = t.util.getBoundsOfCurve(f, l, s[1], s[2], c, h, f, l);
                    break;
                case "s":
                    p = f + s[3],
                    d = l + s[4],
                    c = c ? 2 * f - c : f,
                    h = h ? 2 * l - h : l,
                    g = t.util.getBoundsOfCurve(f, l, c, h, f + s[1], l + s[2], p, d),
                    c = f + s[1],
                    h = l + s[2],
                    f = p,
                    l = d;
                ...
                case "S":
                    ...
                    c = 2 * f - c,
                    h = 2 * l - h,
                    g = t.util.getBoundsOfCurve(f, l, c, h, s[1], s[2], p, d),
                    f = p,
                    l = d,
                    c = s[1],
                    h = s[2];
                ...
                case "q":
                    ...
                    c = f + s[1],
                    h = l + s[2],
                    g = t.util.getBoundsOfCurve(f, l, c, h, c, h, p, d),
                    f = p,
                    l = d;
                    break;
                case "Q":
                    c = s[1],
                    h = s[2],
                    g = t.util.getBoundsOfCurve(f, l, c, h, c, h, s[3], s[4]),
                    f = s[3],
                    l = s[4];
                    break;
                case "t":
                    p = f + s[1],
                    d = l + s[2],
                    o[0].match(/[QqTt]/) === null ? (c = f,
                    h = l) : o[0] === "t" ? (c = 2 * f - v,
                    h = 2 * l - m) : o[0] === "q" && (c = 2 * f - c,
                    h = 2 * l - h),
                    v = c,
                    m = h,
                    g = t.util.getBoundsOfCurve(f, l, c, h, c, h, p, d),
                ...
                case "T":
                    ...
                    break;
                case "a":
                    g = t.util.getBoundsOfArc(f, l, s[1], s[2], s[3], s[4], s[5], s[6] + f, s[7] + l),
                    f += s[6],
                    l += s[7];
                    break;
                case "A":
                    g = t.util.getBoundsOfArc(f, l, s[1], s[2], s[3], s[4], s[5], s[6], s[7]),
                    f = s[6],
                    l = s[7];
                    break;
                case "z":
...
function(e) {
    ...
    t.Group = t.util.createClass(t.Object, t.Collection, {
        ...
        removeWithUpdate: function(e) {
            return this._moveFlippedObject(e),
        ...
        _toggleFlipping: function(e) {
            this.flipX && (e.toggle("flipX"),
            e.set("left", -e.get("left")),
            e.setAngle(-e.getAngle())),
            this.flipY && (e.toggle("flipY"),
            e.set("top", -e.get("top")),
            e.setAngle(-e.getAngle()))
        },
        _restoreObjectState: function(e) {
            return this._setObjectPosition(e),
            e.setCoords(),
        ...
        _calcBounds: function(e) {
            ...
            for (var i = 0, s = this._objects.length; i < s; ++i) {
                ...
                for (var o in r.oCoords)
                    t.push(r.oCoords[o].x),
                    n.push(r.oCoords[o].y)
            }
...
function(e) {
    ...
    fabric.Image = fabric.util.createClass(fabric.Object, {
        ...
        toSVG: function(e) {
            var t = []
              ...
              , r = -this.height / 2
              , i = "none";
            this.group && this.group.type === "path-group" && (n = this.left,
            r = this.top),
            this.alignX !== "none" && this.alignY !== "none" && (i = "x" + this.alignX + "Y" + this.alignY + " " + this.meetOrSlice),
        ...
        applyFilters: function(e, t, n, r) {
            ...
            var i = n
              ...
              , u = this;
            return s.width = i.width,
            s.height = i.height,
            s.getContext("2d").drawImage(i, 0, 0, i.width, i.height),
            t.length === 0 ? (this._element = n,
            e && e(),
            s) : (t.forEach(function(e) {
                e && e.applyTo(s, e.scaleX || u.scaleX, e.scaleY || u.scaleY),
                !r && e.type === "Resize" && (u.width *= e.scaleX,
                u.height *= e.scaleY)
            }),
            o.width = s.width,
            o.height = s.height,
            fabric.isLikelyNode ? (o.src = s.toBuffer(undefined, fabric.Image.pngCompression),
            u._element = o,
            !r && (u._filteredEl = o),
            e && e()) : (o.onload = function() {
                u._element = o,
                !r && (u._filteredEl = o),
                e && e(),
                o.onload = s = i = null
        ...
        _render: function(e, t) {
            var n, r, i = this._findMargins(), s;
            n = t ? this.left : -this.width / 2,
            r = t ? this.top : -this.height / 2,
            this.meetOrSlice === "slice" && (e.beginPath(),
            ...
            s = this.applyFilters(null, this.resizeFilters, this._filteredEl || this._originalElement, !1)) : s = this._element,
        ...
        _findMargins: function() {
            var e = this.width, t = this.height, n, r, i = 0, s = 0;
            if (this.alignX !== "none" || this.alignY !== "none")
                n = [this.width / this._element.width, this.height / this._element.height],
                r = this.meetOrSlice === "meet" ? Math.min.apply(null, n) : Math.max.apply(null, n),
        ...
        _setWidthHeight: function(e) {
            this.width = "width"in e ? e.width : this.getElement() ? this.getElement().width || 0 : 0,
            this.height = "height"in e ? e.height : this.getElement() ? this.getElement().height || 0 : 0
        },
        complexity: function() {
            return 1
        }
    ...
    fabric.Image.fromElement = function(e, n, r) {
        var i = fabric.parseAttributes(e, fabric.Image.ATTRIBUTE_NAMES), s = "xMidYMid", o = "meet", u, a, f;
        i.preserveAspectRatio && (f = i.preserveAspectRatio.split(" ")),
        f && f.length && (o = f.pop(),
        o !== "meet" && o !== "slice" ? (s = o,
        o = "meet") : f.length && (s = f.pop())),
    ...
    t.Image.filters.RemoveWhite = t.util.createClass(t.Image.filters.BaseFilter, {
        ...
        applyTo: function(e) {
            ...
            for (var c = 0, h = r.length; c < h; c += 4)
                ...
                f = r[c + 1],
                l = r[c + 2],
                a > o && f > o && l > o && u(a - f) < s && u(a - l) < s && u(f - l) < s && (r[c + 3] = 1);
            t.putImageData(n, 0, 0)
        },
        toObject: function() {
            return n(this.callSuper("toObject"), {
    ...
    t.Image.filters.Sepia2 = t.util.createClass(t.Image.filters.BaseFilter, {
        ...
        applyTo: function(e) {
            ...
            for (s = 0; s < i; s += 4)
                ...
                u = r[s + 1],
                a = r[s + 2],
                r[s] = (o * .393 + u * .769 + a * .189) / 1.351,
                r[s + 1] = (o * .349 + u * .686 + a * .168) / 1.203,
                r[s + 2] = (o * .272 + u * .534 + a * .131) / 2.14;
            t.putImageData(n, 0, 0)
        }
    }),
...
function(e) {
    ...
    t.Image.filters.Tint = t.util.createClass(t.Image.filters.BaseFilter, {
        ...
        initialize: function(e) {
            ...
            this.opacity = typeof e.opacity != "undefined" ? e.opacity : (new t.Color(this.color)).getAlpha()
        },
        applyTo: function(e) {
...
function(e) {
    ...
    t.Image.filters.Resize = t.util.createClass(t.Image.filters.BaseFilter, {
        ...
        applyTo: function(e, t, n) {
            this.rcpScaleX = 1 / t,
            this.rcpScaleY = 1 / n;
            var r = e.width, i = e.height, s = u(r * t), o = u(i * n), a;
            this.resizeType === "sliceHack" && (a = this.sliceByTwo(e, r, i, s, o)),
            this.resizeType === "hermite" && (a = this.hermiteFastResize(e, r, i, s, o)),
            this.resizeType === "bilinear" && (a = this.bilinearFiltering(e, r, i, s, o)),
            this.resizeType === "lanczos" && (a = this.lanczosResize(e, r, i, s, o)),
            e.width = s,
            e.height = o,
            e.getContext("2d").putImageData(a, 0, 0)
        },
        sliceByTwo: function(e, n, i, s, u) {
            var a = e.getContext("2d"), f, l = .5, c = .5, h = 1, p = 1, d = !1, v = !1, m = n, g = i, y = t.util.createCanvasElement(), b = y.getContext("2d");
            s = r(s),
            u = r(u),
            y.width = o(s, n),
            y.height = o(u, i),
            ...
            while (!d || !v)
                n = m,
                i = g,
                s * h < r(m * l * h) ? m = r(m * l) : (m = s,
                d = !0),
                u * p < r(g * c * p) ? g = r(g * c) : (g = u,
                v = !0),
                f = a.getImageData(0, 0, n, i),
        ...
        bilinearFiltering: function(e, t, n, i, s) {
            var o, u, a, f, l, c, h, p, d, v, m, g, y = 0, b, w = this.rcpScaleX, E = this.rcpScaleY, S = e.getContext("2d"), x = 4 * (t - 1), T = S.getImageData(0, 0, t, n), N = T.data, C = S.getImageData(0, 0, i, s), k = C.data;
            for (h = 0; h < s; h++)
                for (p = 0; p < i; p++) {
                    l = r(w * p),
                    c = r(E * h),
                    ...
                    for (m = 0; m < 4; m++)
                        ...
                        a = N[b + x + m],
                        f = N[b + x + 4 + m],
                        g = o * (1 - d) * (1 - v) + u * d * (1 - v) + a * v * (1 - d) + f * d * v,
                        k[y++] = g
                }
            return C
        },
...
function(e) {
    ...
    t.Text = t.util.createClass(t.Object, {
        ...
        _renderViaNative: function(e) {
            ...
            this.textAlign !== "left" && this.textAlign !== "justify" && e.restore(),
        ...
        _translateForTextAlign: function(e) {
            this.textAlign !== "left" && this.textAlign !== "justify" && (e.save(),
            e.translate(this.textAlign === "center" ? this.width / 2 : this.width, 0))
        },
        ...
        _renderTextFill: function(e, t) {
            ...
            for (var r = 0, i = t.length; r < i; r++) {
                ...
                n += s,
                this._renderTextLine("fillText", e, t[r], this._getLeftOffset(), this._getTopOffset() + n, r)
            }
            this.shadow && !this.shadow.affectStroke && this._removeShadow(e)
        },
        _renderTextStroke: function(e, t) {
            ...
            for (var r = 0, i = t.length; r < i; r++) {
                ...
                n += o,
                this._renderTextLine("strokeText", e, t[r], this._getLeftOffset(), this._getTopOffset() + n, r)
            }
            e.closePath(),
            e.restore()
        },
        ...
        render: function(e, t) {
            ...
            n && e.translate(-this.group.width / 2, -this.group.height / 2),
            this.transformMatrix && e.transform.apply(e, this.transformMatrix),
            n && e.translate(this.left, this.top),
            this._render(e),
            e.restore()
        },
        toObject: function(e) {
        ...
        _getSVGShadows: function(e, n) {
            ...
            o = n.length; s < o; s++)
                if (n[s] !== "") {
                    ...
                    r.push('<tspan x="', i(a + u + this.shadow.offsetX, 2), s === 0 || this.useNative ? '" y' : '" dy', '="', i(this.useNative ? e * s - this.height / 2 + this.shadow.offsetY : e + (s === 0 ? this.shadow.offsetY : 0), 2), '" ', this._getFillAttributes(this.shadow.color), ">", t.util.string.escapeXml(n[s]), "</tspan>"),
                    u = 1
                } else
                    u++;
            return r
        ...
        _getSVGTextAndBg: function(e, t, n) {
            ...
            for (var o = 0, u = n.length; o < u; o++) {
                n[o] !== "" ? (this._setSVGTextLineText(n[o], o, r, e, s, i),
                s = 1) : s++;
        ...
        _set: function(e, t) {
            e === "fontFamily" && this.path && (this.path = this.path.replace(/(.*?)([^\/]*)(\.font\.js)/, "$1" + t + "$3")),
            this.callSuper("_set", e, t),
    ...
    t.Text.fromElement = function(e, n) {
        ...
        var i = new t.Text(e.textContent,n)
          , s = 0;
        return i.originX === "left" && (s = i.getWidth() / 2),
...
function() {
    ...
    fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, {
        ...
        setSelectionStart: function(e) {
            this.selectionStart !== e && (this.fire("selection:changed"),
        ...
        setSelectionEnd: function(e) {
            this.selectionEnd !== e && (this.fire("selection:changed"),
            this.canvas && this.canvas.fire("text:selection:changed", {
                target: this
            })),
            this.selectionEnd = e,
        ...
        _extendStyles: function(e, t) {
            ...
            this.styles[n.lineIndex][n.charIndex] || (this.styles[n.lineIndex][n.charIndex] = {}),
        ...
        renderCursorOrSelection: function() {
            ...
            this.selectionStart === this.selectionEnd ? (t = this._getCursorBoundaries(e, "cursor"),
            this.renderCursor(t)) : (t = this._getCursorBoundaries(e, "selection"),
        ...
        _getCursorBoundariesOffsets: function(e, t, n, r) {
            ...
            for (var f = 0; f < this.selectionStart; f++) {
                if (e[f] === "\n") {
                    ...
                    a += this._getCachedLineHeight(l),
                    s++,
                    o = 0
                } else
                    u += this._getWidthOfChar(this.ctx, e[f], s, o),
                    o++;
        ...
        renderCursor: function(e) {
            ...
            t.fillRect(e.left + o, e.top + e.topOffset, this.cursorWidth / this.scaleX, s),
            t.restore()
        },
            ...
            for (var a = s; a <= o; a++) {
                ...
                if (a === s)
                    for (var h = 0, p = u[a].length; h < p; h++)
                        h >= r.charIndex && (a !== o || h < i.charIndex) && (c += this._getWidthOfChar(n, u[a][h], a, h)),
                        h < r.charIndex && (f += this._getWidthOfChar(n, u[a][h], a, h));
                else if (a > s && a < o)
                    c += this._getCachedLineWidth(a, u) || 5;
                else if (a === o)
                    for (var d = 0, v = i.charIndex; d < v; d++)
                        c += this._getWidthOfChar(n, u[a][d], a, d);
                n.fillRect(t.left + f, t.top + t.topOffset, c, l),
                t.topOffset += l
            }
            n.restore()
        },
        _renderChars: function(e, t, n, r, i, s) {
            ...
            for (var p = 0, d = l.length; p <= d; p++) {
                ...
                if (this._hasStyleChanged(c, v) || p === d)
                    this._renderChar(e, t, s, p - 1, h, r, i, a),
                    h = "",
                    c = v;
                h += l[p]
            }
        ...
        _renderCharsFast: function(e, t, n, r, i) {
            ...
            e === "fillText" && this.fill && this.callSuper("_renderChars", e, t, n, r, i),
            e === "strokeText" && this.stroke && this.callSuper("_renderChars", e, t, n, r, i)
        },
        ...
        _renderCharDecoration: function(e, t, n, r, i, s, o) {
            ...
            if (!u)
                return;
            u.indexOf("underline") > -1 && this._renderCharDecorationAtOffset(e, n, r + this.fontSize / this._fontSizeFraction, i, 0, this.fontSize / 20),
            u.indexOf("line-through") > -1 && this._renderCharDecorationAtOffset(e, n, r + this.fontSize / this._fontSizeFraction, i, o / 2, a / 20),
            u.indexOf("overline") > -1 && this._renderCharDecorationAtOffset(e, n, r, i, s - this.fontSize / this._fontSizeFraction, this.fontSize / 20)
        },
        ...
        _renderTextLinesBackground: function(e, t) {
            ...
            for (var i = 0, s = t.length; i < s; i++) {
                ...
                this.textBackgroundColor && (e.fillStyle = this.textBackgroundColor,
                e.fillRect(this._getLeftOffset() + a, this._getTopOffset() + n + r, u, o));
                if (this.styles[i])
                    for (var f = 0, l = t[i].length; f < l; f++)
                        if (this.styles[i] && this.styles[i][f] && this.styles[i][f].textBackgroundColor) {
                            ...
                            e.fillRect(this._getLeftOffset() + a + this._getWidthOfCharsAt(e, i, f, t), this._getTopOffset() + n + r, this._getWidthOfChar(e, c, i, f, t) + 1, o)
                        }
                n += o
            }
            e.restore()
        ...
        _applyCharStylesGetWidth: function(t, n, r, i, s) {
            ...
            return t.fillStyle = a.toLive ? a.toLive(t) : a,
            o.stroke && (t.strokeStyle = o.stroke && o.stroke.toLive ? o.stroke.toLive(t) : o.stroke),
            t.lineWidth = o.strokeWidth || this.strokeWidth,
            t.font = this._getFontDeclaration.call(o),
            this._setShadow.call(o, t),
            this.caching ? (this._charWidthsCache[u] || (this._charWidthsCache[u] = t.measureText(n).width),
        ...
        _renderTextBoxBackground: function(e) {
            ...
            e.save(),
            e.fillStyle = this.backgroundColor,
            e.fillRect(this._getLeftOffset(), this._getTopOffset() + this.fontSize / this._fontSizeFraction, this.width, this.height),
            e.restore()
        },
        toObject: function(t) {
...
function() {
    ...
    fabric.util.object.extend(fabric.IText.prototype, {
        ...
        initDelayedCursor: function(e) {
            ...
            e && (this._abortCursorAnimation = !0,
        ...
        insertChars: function(e) {
            ...
            this.selectionStart === this.selectionEnd && this.insertStyleObjects(e, t, this.copiedStyles),
        ...
        insertNewlineStyleObject: function(t, n, r) {
            ...
            if (r)
                ...
                for (var o in this.styles[t])
                    parseInt(o, 10) >= n && (s[parseInt(o, 10) - n] = this.styles[t][o],
...
fabric.util.object.extend(fabric.IText.prototype, {
    ...
    initMouseupHandler: function() {
        this.on("mouseup", function(e) {
            ...
            if (this._isObjectMoved(e.e))
                return;
            this.__lastSelected && (this.enterEditing(),
            this.initDelayedCursor(!0)),
            this.selected = !0
        })
    },
    setCursorByClick: function(e) {
        ...
        e.shiftKey ? t < this.selectionStart ? (this.setSelectionEnd(this.selectionStart),
    ...
    getSelectionStartFromPointer: function(e) {
        ...
        for (var a = 0, f = n.length; a < f; a++) {
            ...
            for (var h = 0, p = n[a].length; h < p; h++) {
                var d = n[a][h];
                r = i,
                i += this._getWidthOfChar(this.ctx, d, a, this.flipX ? p - h : h) * this.scaleX;
                if (s <= t.y || i <= t.x) {
                    o++;
                    continue
                }
...
fabric.util.object.extend(fabric.IText.prototype, {
    ...
    getDownCursorOffset: function(e, t) {
        ...
        if (c.lineIndex === r.length - 1 || e.metaKey || e.keyCode === 34)
        ...
        for (var v = 0, m = a.length; v < m; v++)
            i = a[v],
            p += this._getWidthOfChar(this.ctx, i, d, v);
    ...
    moveCursorDown: function(e) {
        ...
        e.shiftKey ? this.moveCursorDownWithShift(t) : this.moveCursorDownWithoutShift(t),
    ...
    moveCursorDownWithShift: function(e) {
        ...
        this[t] += e,
        this.selectionEnd < this.selectionStart && this._selectionDirection === "left" && (this.swapSelectionPoints(),
        this._selectionDirection = "right"),
    ...
    getUpCursorOffset: function(e, t) {
        ...
        if (r.lineIndex === 0 || e.metaKey || e.keyCode === 33)
            return n;
        ...
        for (var p = 0, d = s.length; p < d; p++)
            a = s[p],
            c += this._getWidthOfChar(this.ctx, a, h, p);
    ...
    moveCursorUp: function(e) {
        ...
        e.shiftKey ? this.moveCursorUpWithShift(t) : this.moveCursorUpWithoutShift(t),
        this.initDelayedCursor()
    },
    moveCursorUpWithShift: function(e) {
        ...
        var t = this._selectionDirection === "right" ? "selectionEnd" : "selectionStart";
        this[t] -= e,
        this.selectionEnd < this.selectionStart && this._selectionDirection === "right" && (this.swapSelectionPoints(),
    ...
    moveCursorLeft: function(e) {
        ...
        this.abortCursorAnimation(),
        this._currentCursorOpacity = 1,
        e.shiftKey ? this.moveCursorLeftWithShift(e) : this.moveCursorLeftWithoutShift(e),
        this.initDelayedCursor()
    },
    ...
    moveCursorLeftWithoutShift: function(e) {
        this._selectionDirection = "left",
        this.selectionEnd === this.selectionStart && this._moveLeft(e, "selectionStart"),
        this.selectionEnd = this.selectionStart,
        this.fire("selection:changed"),
        this.canvas && this.canvas.fire("text:selection:changed", {
            target: this
    ...
    moveCursorLeftWithShift: function(e) {
        this._selectionDirection === "right" && this.selectionStart !== this.selectionEnd ? this._moveLeft(e, "selectionEnd") : (this._selectionDirection = "left",
    ...
    moveCursorRight: function(e) {
        ...
        this.abortCursorAnimation(),
        this._currentCursorOpacity = 1,
        e.shiftKey ? this.moveCursorRightWithShift(e) : this.moveCursorRightWithoutShift(e),
        this.initDelayedCursor()
    },
    moveCursorRightWithShift: function(e) {
        this._selectionDirection === "left" && this.selectionStart !== this.selectionEnd ? this._moveRight(e, "selectionStart") : (this._selectionDirection = "right",
    ...
    moveCursorRightWithoutShift: function(e) {
        this._selectionDirection = "right",
        this.selectionStart === this.selectionEnd ? (this._moveRight(e, "selectionStart"),
...
fabric.util.object.extend(fabric.IText.prototype, {
    ...
    _setSVGTextLineChars: function(e, t, n, r, i, s) {
        ...
        for (var h = 0, p = u.length; h < p; h++) {
            ...
            d.textBackgroundColor && s.push(this._createTextCharBg(d, f, l, c, v, a)),
            a += v
        }
    },
...
function() {
    ...
    fabric.util.loadImage = function(e, t, n) {
        function r(r) {
            i.src = new Buffer(r,"binary"),
            i._src = e,
            t && t.call(n, i)
        }
        var i = new Image;
        e && (e instanceof Buffer || e.indexOf("data") === 0) ? (i.src = i._src = e,
        t && t.call(n, i)) : e && e.indexOf("http") !== 0 ? requestFs(e, r) : e ? request(e, "binary", r) : t && t.call(n, e)
    }
    ,
    fabric.loadSVGFromURL = function(e, t, n) {
        e = e.replace(/^\n\s*/, "").replace(/\?.*$/, "").trim(),
        e.indexOf("http") !== 0 ? requestFs(e, function(e) {
    ...
    fabric.createCanvasForNode = function(e, t, n, r) {
        ...
        var o = fabric.Canvas || fabric.StaticCanvas
          , u = new o(i,n);
        return u.contextContainer = s.getContext("2d"),
        u.nodeCanvas = s,
        u.Font = Canvas.Font,
        u
    }
    ...
    fabric.StaticCanvas.prototype.setWidth = function(e, t) {
        return origSetWidth.call(this, e, t),
        this.nodeCanvas.width = e,
        this
    }
    ,
    ...
    fabric.StaticCanvas.prototype.setHeight = function(e, t) {
        return origSetHeight.call(this, e, t),
        this.nodeCanvas.height = e,
        this
    }
    ,
